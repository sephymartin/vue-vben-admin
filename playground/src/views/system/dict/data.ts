  ...
  return [
    {
      ...
      rules: z
        ...
        .max(50, $t('ui.formRules.maxLength', [$t('system.dict.type.typeCode'), 50])),
    },
    {
      component: 'Input',
      fieldName: 'typeName',
      ...
      rules: z
        ...
        .max(100, $t('ui.formRules.maxLength', [$t('system.dict.type.typeName'), 100])),
    },
    {
  ...
  return [
    {
      ...
      rules: z
        ...
        .max(50, $t('ui.formRules.maxLength', [$t('system.dict.item.itemCode'), 50])),
    },
    {
      component: 'Input',
      fieldName: 'itemLabel',
      ...
      rules: z
        ...
        .max(100, $t('ui.formRules.maxLength', [$t('system.dict.item.itemLabel'), 100])),
    },
    {
      component: 'Input',
      fieldName: 'itemValue',
...
export function useItemColumns(
  ...
  onStatusChange?: (newStatus: any, row: DictApi.DictItem) => PromiseLike<boolean | undefined>,
